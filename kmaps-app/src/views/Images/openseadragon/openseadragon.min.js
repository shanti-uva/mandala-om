                    ...
                    if (s !== (n = e[t]))
                        if (
                            ...
                            if (o) {
                                ...
                                r =
                                    i && OpenSeadragon.isPlainObject(i)
                                        ? i
                                        : {};
...
!(function (v) {
    ...
    v.MouseTracker = function (e) {
        ...
        this.clickTimeThreshold =
            e.clickTimeThreshold || v.DEFAULT_SETTINGS.clickTimeThreshold;
        this.clickDistThreshold =
            e.clickDistThreshold || v.DEFAULT_SETTINGS.clickDistThreshold;
        this.dblClickTimeThreshold =
            e.dblClickTimeThreshold || v.DEFAULT_SETTINGS.dblClickTimeThreshold;
        this.dblClickDistThreshold =
            e.dblClickDistThreshold || v.DEFAULT_SETTINGS.dblClickDistThreshold;
        ...
        f[this.hash] = {
            ...
            mouseover: function (e) {
                !(function (e, t) {
                    if (
                        (t = v.getEvent(t)).currentTarget === t.relatedTarget ||
                        x(t.currentTarget, t.relatedTarget)
                    )
                        return;
                    S(e, t);
                })(o, e);
            ...
            touchcancel: function (e) {
                (i = e),
                    (n = (t = o).getActivePointersListByType('touch')),
                    b(t, i, n);
                var t, i, n;
            },
            ...
            pointerupcaptured: function (e) {
                !(function (e, t) {
                    e.getActivePointersListByType(p(t)).getById(t.pointerId) &&
                        M(e, t);
                    v.stopEvent(t);
                })(o, e);
            },
            ...
            (e
                ? function (e) {
                      ...
                      if (!n.tracking) {
                          for (
                              i = 0;
                              i < v.MouseTracker.subscribeEvents.length;
                              i++
                          ) {
    ...
    v.MouseTracker.wheelEventName =
        (v.Browser.vendor == v.BROWSERS.IE && 8 < v.Browser.version) ||
        'onwheel' in document.createElement('div')
            ? 'wheel'
            : void 0 !== document.onmousewheel
            ? 'mousewheel'
            : 'DOMMouseScroll';
    v.MouseTracker.supportsMouseCapture =
        ((e = document.createElement('div')),
        v.isFunction(e.setCapture) && v.isFunction(e.releaseCapture));
    var e;
    v.MouseTracker.subscribeEvents = [
        'click',
        'dblclick',
        'keydown',
        'keyup',
    ...
    'DOMMouseScroll' == v.MouseTracker.wheelEventName &&
        v.MouseTracker.subscribeEvents.push('MozMousePixelScroll');
    if (
        window.PointerEvent &&
        (window.navigator.pointerEnabled || v.Browser.vendor !== v.BROWSERS.IE)
    ) {
        v.MouseTracker.havePointerEvents = !0;
        v.MouseTracker.subscribeEvents.push(
            'pointerover',
            'pointerout',
            'pointerdown',
            'pointerup',
        ...
        navigator.maxTouchPoints
            ...
            : (v.MouseTracker.maxTouchPoints = 0);
        ...
        navigator.msMaxTouchPoints
            ? (v.MouseTracker.maxTouchPoints = navigator.msMaxTouchPoints)
            : (v.MouseTracker.maxTouchPoints = 0);
        v.MouseTracker.haveMouseEnter = !1;
    } else {
    ...
    function o(e) {
        ...
        for (t = 0; t < n; t++)
            if (0 < i.activePointersLists[t].captureCount) {
                ...
                v.removeEvent(
                    v.MouseTracker.captureElement,
                    v.MouseTracker.unprefixedPointerEvents
                        ? 'pointermove'
                        : 'MSPointerMove',
    ...
    function a(e, t) {
        ...
        if ('pointerevent' === t)
            return {
                upName: v.MouseTracker.unprefixedPointerEvents
                    ? 'pointerup'
                    : 'MSPointerUp',
                upHandler: i.pointerupcaptured,
                moveName: v.MouseTracker.unprefixedPointerEvents
                    ? 'pointermove'
                    : 'MSPointerMove',
    ...
    function u(e, t, i) {
        ...
        if (1 === o.captureCount)
            if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9)
                ...
                G &&
                    $(window.top) &&
                    v.addEvent(window.top, n.upName, n.upHandler, !0);
                v.addEvent(
                    v.MouseTracker.captureElement,
                    n.upName,
                    n.upHandler,
    ...
    function d(e, t, i) {
        ...
        if (0 === o.captureCount)
            if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9)
                ...
                G &&
                    $(window.top) &&
                    v.removeEvent(window.top, n.upName, n.upHandler, !0);
                v.removeEvent(
                    v.MouseTracker.captureElement,
                    n.moveName,
                    n.moveHandler,
    ...
    function i(e, t) {
        ...
        'mousewheel' == v.MouseTracker.wheelEventName
            ? (i.deltaY = -t.wheelDelta / v.DEFAULT_SETTINGS.pixelsPerWheelLine)
            : (i.deltaY = t.detail);
        T(e, i, t);
    }
    function T(e, t, i) {
    ...
    function P(e) {
        return v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9
            ? 1 === e
                ? 0
                : 2 === e
                ? 2
    ...
    function I(e, t) {
        t.currentTarget === t.relatedTarget ||
            x(t.currentTarget, t.relatedTarget) ||
            N(e, t, [
                {
                    id: t.pointerId,
    ...
    function V(e, t, i, n) {
        ...
        for (o = 0; o < h; o++) {
            ...
            (e.dragHandler || e.dragEndHandler || e.pinchHandler) &&
                v.MouseTracker.gesturePointVelocityTracker.addPoint(e, r);
            if (1 === l.contacts)
                e.pressHandler &&
                    !1 ===
                        e.pressHandler({
                ...
                a.lastPinchCenter = a.currentPinchCenter = y(
        ...
        for (s = 0; s < d; s++) {
            ...
            if ((l = u.getById(a.id))) {
                ...
                if (g) {
                    u.removeContact();
                    (e.dragHandler || e.dragEndHandler || e.pinchHandler) &&
                        v.MouseTracker.gesturePointVelocityTracker.removePoint(
                            e,
                            l
                        );
                    if (0 === u.contacts) {
                        ...
                        if (
                            ...
                            h =
                                r - l.contactTime <= e.clickTimeThreshold &&
                                l.contactPos.distanceTo(o) <=
                                    e.clickDistThreshold;
                            e.clickHandler &&
                                !1 ===
                                    e.clickHandler({
                                        eventSource: e,
                            ...
                            if (e.dblClickHandler && h) {
                                ...
                                if (1 === u.clicks) {
                                    ...
                                    u.clicks = 0;
                                    c.lastClickPos.distanceTo(o) <=
                                        e.dblClickDistThreshold &&
                                        !1 ===
                                            e.dblClickHandler({
                                                eventSource: e,
                                                pointerType: l.type,
    ...
    function j(n, o, r) {
        ...
        if (0 === h.contacts)
            ...
            if (n.moveHandler) {
                ...
                !1 ===
                    n.moveHandler({
                        ...
                        position: w(
                            y(s[0].currentPos, s[1].currentPos),
                            n.element
                        ),
                        buttons: h.buttons,
            ...
            if (
                n.pinchHandler &&
                'touch' === r[0].type &&
                (a = l.pinchGPoints[0].currentPos.distanceTo(
    ...
    o.Control = function (e, t, i) {
        ...
        if (this.anchor == o.ControlAnchor.ABSOLUTE) {
            ...
            this.wrapper.style.top =
                'number' == typeof t.top ? t.top + 'px' : t.top;
...
!(function (m) {
    ...
    m.extend(
        ...
        m.ControlDock.prototype,
        {
                ...
                if (i)
                    if (this.sequenceMode && m.isArray(i)) {
                        ...
                        if (i.length) {
                            ...
                            function t(i) {
                                (m.isPlainObject(i) && i.tileSource) ||
                                    (i = { tileSource: i });
                                if (void 0 !== i.index) {
                                    m.console.error(
                                ...
                                i.success = function (e) {
                                    ...
                                    if (i.tileSource.overlays)
                                        for (
                                            var t = 0;
                                            t < i.tileSource.overlays.length;
                                            t++
                                        )
                                            o.addOverlay(
                                                i.tileSource.overlays[t]
                                            );
                                    n && n(e);
                                    l();
                                };
            ...
            addTiledImage: function (i) {
                ...
                m.console.assert(
                    !i.replace ||
                        (-1 < i.index && i.index < this.world.getItemCount()),
                ...
                void 0 === i.crossOriginPolicy &&
                    (i.crossOriginPolicy =
                        void 0 !== i.tileSource.crossOriginPolicy
                            ? i.tileSource.crossOriginPolicy
                                ...
                                void 0 !== o.crossOriginPolicy ||
                                    ...
                                    (o.crossOriginPolicy =
                                        void 0 !== r.crossOriginPolicy
                                            ? r.crossOriginPolicy
                                            : n.crossOriginPolicy);
                                void 0 === o.ajaxWithCredentials &&
                                    (o.ajaxWithCredentials =
                                        n.ajaxWithCredentials);
                                void 0 === o.useCanvas &&
                                    (o.useCanvas = n.useCanvas);
                ...
                function s() {
                    ...
                    for (
                        ;
                        o._loadQueue.length && (e = o._loadQueue[0]).tileSource;

                    ) {
                        o._loadQueue.splice(0, 1);
                        if (e.options.replace) {
                            var n = o.world.getIndexOfItem(
                                e.options.replaceItem
                            );
                        ...
                        t = new m.TiledImage({
                            ...
                            placeholderFillStyle:
                                e.options.placeholderFillStyle,
            ...
            addSimpleImage: function (e) {
                ...
                var t = m.extend({}, e, {
                    tileSource: { type: 'image', url: e.url },
                });
                delete t.url;
            ...
            getOverlayById: function (e) {
                var t;
                e = m.getElement(e);
                return 0 <= (t = s(this.currentOverlays, e))
                    ? this.currentOverlays[t]
                    : null;
            },
    ...
    function d(e, t) {
        ...
        if (!o) {
            ...
            var l = t.y;
            if (void 0 !== t.px) {
                var h = e.viewport.imageToViewportRectangle(
        ...
        c &&
            'string' === m.type(c) &&
            (c = m.Placement[t.placement.toUpperCase()]);
    ...
    function x(e) {
        if (!e.preventDefaultAction && this.viewport) {
            ...
            if (t.flickEnabled && e.speed >= t.flickMinSpeed) {
                var i = 0;
                this.panHorizontal &&
                    (i = t.flickMomentum * e.speed * Math.cos(e.direction));
                var n = 0;
                this.panVertical &&
                    (n = t.flickMomentum * e.speed * Math.sin(e.direction));
                var o = this.viewport.pixelFromPoint(
                    this.viewport.getCenter(!0)
                );
                var r = this.viewport.pointFromPixel(
                    new m.Point(o.x - i, o.y - n)
                );
    ...
    function E(e) {
        window.location != window.parent.location &&
            m.MouseTracker.resetAllMouseTrackers();
    ...
    function V() {
        if (this.viewport) {
            ...
            e = this.viewport.flipped
                ? m.positiveModulo(e + this.rotationIncrement, 360)
                : m.positiveModulo(e - this.rotationIncrement, 360);
...
!(function (c) {
    c.Navigator = function (i) {
        ...
        if (i.id) {
            ...
            if (i.position)
                if ('BOTTOM_RIGHT' == i.position)
                    i.controlOptions.anchor = c.ControlAnchor.BOTTOM_RIGHT;
                else if ('BOTTOM_LEFT' == i.position)
                    i.controlOptions.anchor = c.ControlAnchor.BOTTOM_LEFT;
                else if ('TOP_RIGHT' == i.position)
                    i.controlOptions.anchor = c.ControlAnchor.TOP_RIGHT;
                else if ('TOP_LEFT' == i.position)
                    i.controlOptions.anchor = c.ControlAnchor.TOP_LEFT;
        ...
        this.totalBorderWidths = new c.Point(
            2 * this.borderWidth,
            2 * this.borderWidth
        ).minus(this.fudge);
    ...
    c.extend(
        c.Navigator.prototype,
        c.EventSource.prototype,
        c.Viewer.prototype,
        {
            updateSize: function () {
                if (this.viewport) {
            ...
            update: function (e) {
                ...
                if (e && this.viewport) {
                    ...
                    r = this.viewport.pixelFromPointNoRotate(
                        o.getTopLeft(),
                        !1
                    );
                    s = this.viewport
                        .pixelFromPointNoRotate(o.getBottomRight(), !1)
            ...
            _getMatchingItem: function (e) {
                ...
                for (var n = 0; n < t; n++)
                    if (
                        (i = this.world.getItemAt(n))._originalForNavigator ===
                        e
                    )
                        return i;
                return null;
...
!(function (d) {
    ...
    d.TileSource.prototype = {
        ...
        getClosestLevel: function () {
            ...
            for (
                e = this.minLevel + 1;
                e <= this.maxLevel &&
                !(1 < (t = this.getNumTiles(e)).x || 1 < t.y);
                e++
            );
            return e - 1;
        },
        getTileAtPoint: function (e, t) {
            var i =
                0 <= t.x && t.x <= 1 && 0 <= t.y && t.y <= 1 / this.aspectRatio;
            d.console.assert(
                i,
            ...
            t.y >= 1 / this.aspectRatio - 1e-15 &&
                (a = this.getNumTiles(e).y - 1);
        ...
        getImageInfo: function (n) {
            ...
            n &&
                -1 <
                    (a = (s = (t = n.split('/'))[t.length - 1]).lastIndexOf(
                        '.'
                    )) &&
                (t[t.length - 1] = s.slice(0, a));
            i = function (e) {
                'string' == typeof e && (e = d.parseXml(e));
                var t = d.TileSource.determineType(l, e, n);
                if (t) {
                    void 0 ===
                        (r = t.prototype.configure.apply(l, [e, n]))
                            .ajaxWithCredentials &&
                        (r.ajaxWithCredentials = l.ajaxWithCredentials);
                    o = new t(r);
                    l.ready = !0;
                    ...
                    success: function (e) {
                        var t = (function (t) {
                                ...
                                o = t.status;
                            {
                                if (!t)
                                    throw new Error(
                                        d.getString('Errors.Security')
                                    );
                                if (200 !== t.status && 0 !== t.status) {
                                    o = t.status;
                                    e = 404 == o ? 'Not Found' : t.statusText;
                                    throw new Error(
                                        d.getString('Errors.Status', o, e)
                                    );
                                }
                            }
                            if (n.match(/\s*<.*/))
    ...
    d.TileSource.determineType = function (e, t, i) {
        ...
        for (n in OpenSeadragon)
            if (
                n.match(/.+TileSource$/) &&
                d.isFunction(OpenSeadragon[n]) &&
                d.isFunction(OpenSeadragon[n].prototype.supports) &&
...
!(function (g) {
    g.DziTileSource = function (e, t, i, n, o, r, s, a, l) {
        ...
        if (this.displayRects)
            for (h = this.displayRects.length - 1; 0 <= h; h--)
                for (
                    u = (c = this.displayRects[h]).minLevel;
                    u <= c.maxLevel;
                    u++
                ) {
    ...
    g.extend(g.DziTileSource.prototype, g.TileSource.prototype, {
        ...
        configure: function (e, t) {
            ...
            i = (g.isPlainObject(e)
                ...
                : function (e, t) {
                      ...
                      if ('Image' == l)
                          try {
                              void 0 ===
                                  (r = a.getElementsByTagName('Size')[0]) &&
                              ...
                              c = {
                                  Image: {
                                      ...
                                      DisplayRect: null,
                                      Overlap: parseInt(
                                          a.getAttribute('Overlap'),
                                          10
                                      ),
                                      TileSize: parseInt(
                                          a.getAttribute('TileSize'),
                                          10
                                      ),
                                      Size: {
                                          Height: parseInt(
                              ...
                              if (!g.imageFormatSupported(c.Image.Format))
                                  throw new Error(
                                      g.getString(
                                          'Errors.ImageFormat',
                                          c.Image.Format.toUpperCase()
                                      )
                                  );
                              void 0 ===
                                  (i = a.getElementsByTagName('DisplayRect')) &&
                                  (i = a.getElementsByTagNameNS(
                                      h,
                                      'DisplayRect'
                                  )[0]);
                              for (s = 0; s < i.length; s++) {
                                  ...
                                  u.push({
                                      Rect: {
                                          ...
                                          MinLevel: parseInt(
                                              n.getAttribute('MinLevel'),
                                              10
                                          ),
                                          MaxLevel: parseInt(
                                              n.getAttribute('MaxLevel'),
                                              10
                                          ),
                                      },
                                  });
                              ...
                              throw e instanceof Error
                                  ? e
                                  : new Error(g.getString('Errors.Dzi'));
                          }
                      else {
                          if ('Collection' == l)
                              throw new Error(g.getString('Errors.Dzc'));
                          if ('Error' == l) {
                              var d = a.getElementsByTagName('Message')[0]
            ...
            if (t && !i.tilesUrl) {
                i.tilesUrl = t.replace(
                    /([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/,
                    '$1_files/'
                );
                -1 != t.search(/\.(dzi|xml|js)\?/)
                    ? (i.queryParams = t.match(/\?.*/))
                    : (i.queryParams = '');
            }
            return i;
        },
...
!(function (h) {
        ...
        if (this.tile_width && this.tile_height) {
            ...
            if (1 == this.tiles.length) {
                ...
                for (var t = 0; t < this.tiles.length; t++)
                    for (
                        var i = 0;
                        i < this.tiles[t].scaleFactors.length;
                        i++
                    ) {
            ...
            0 < s.length
                ? (e.tileSize = Math.max.apply(null, s))
                : (e.tileSize = o);
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
        ...
        getTileWidth: function (e) {
            ...
            return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[t]
                ? this.tileSizePerScaleFactor[t].width
                : this._tileWidth;
        },
        getTileHeight: function (e) {
            if (this.emulateLegacyImagePyramid)
            ...
            var t = Math.pow(2, this.maxLevel - e);
            return this.tileSizePerScaleFactor && this.tileSizePerScaleFactor[t]
                ? this.tileSizePerScaleFactor[t].height
                : this._tileHeight;
        },
        getLevelScale: function (e) {
            if (this.emulateLegacyImagePyramid) {
        ...
        getTileUrl: function (e, t, i) {
            ...
            if (w < o && y < r) {
                ...
                l =
                    0 === t && 0 === i && u === this.width && d === this.height
                        ? 'full'
                        : [h, c, u, d].join(',');
                g = Math.ceil(u * f);
                m = Math.ceil(d * f);
    ...
    l.extend(l.LegacyTileSource.prototype, l.TileSource.prototype, {
        ...
        configure: function (e, t) {
            return (l.isPlainObject(e)
                ...
                : function (e, t) {
                      if (!t || !t.documentElement)
                          throw new Error(l.getString('Errors.Xml'));
                      var i,
                          n,
                          o = t.documentElement,
                          r = o.tagName,
    ...
    a.extend(a.ImageTileSource.prototype, a.TileSource.prototype, {
        ...
        getImageInfo: function (e) {
            ...
            this.ajaxWithCredentials &&
                (t.useCredentials = this.ajaxWithCredentials);
            a.addEvent(t, 'load', function () {
                i.width = Object.prototype.hasOwnProperty.call(
                    t,
                    'naturalWidth'
                )
                    ? t.naturalWidth
                    : t.width;
                i.height = Object.prototype.hasOwnProperty.call(
                    t,
                    'naturalHeight'
                )
                    ? t.naturalHeight
    ...
    o.Button = function (e) {
        ...
        if (!e.element) {
            ...
            this.imgHover.style.visibility = this.imgDown.style.visibility =
                'hidden';
            o.Browser.vendor == o.BROWSERS.FIREFOX &&
                o.Browser.version < 3 &&
                (this.imgGroup.style.top = this.imgHover.style.top = this.imgDown.style.top =
                    '');
...
!(function (R) {
    ...
    R.Rect.prototype = {
        ...
        getTopRight: function () {
            return new R.Point(this.x + this.width, this.y).rotate(
                this.degrees,
                this.getTopLeft()
            );
        },
        getBottomLeft: function () {
            return new R.Point(this.x, this.y + this.height).rotate(
                this.degrees,
                this.getTopLeft()
            );
        },
        ...
        intersection: function (e) {
            ...
            function w(e, t, i, n) {
                ...
                return -h <= a && a <= 1 - h && -h <= l && l <= 1 - h
                    ? new R.Point(e.x + l * o.x, e.y + l * o.y)
                    : null;
            }
...
!(function (d) {
            ...
            t.innerTracker = new d.MouseTracker({
                ...
                releaseHandler: function (e) {
                    ...
                    if (
                        ...
                        t.dragging &&
                        o - t.dragging < t.clickTimeThreshold
                    ) {
                        t.dragging = null;
                        r.goToPage(n);
                    }
    ...
    d.extend(
        d.ReferenceStrip.prototype,
        d.EventSource.prototype,
        d.Viewer.prototype,
        {
            setFocus: function (e) {
                var t,
    ...
    function h(e, t, i) {
        ...
        for (
            l = o =
                (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0
                    ? 0
                    : o;
            l < r && l < e.panels.length;
            l++
        )
    ...
    function u(e) {
        var t = e.eventSource.element;
        'horizontal' == this.scroll
            ? (t.style.marginBottom = '-' + d.getElementSize(t).y / 2 + 'px')
            : (t.style.marginLeft = '-' + d.getElementSize(t).x / 2 + 'px');
        return !1;
    }
    function p(e) {
...
!(function (t) {
    function n(e) {
        t.extend(
            !0,
            this,
            { timeout: t.DEFAULT_SETTINGS.timeout, jobId: null },
            e
        );
        this.image = null;
    }
...
!(function (c) {
    ...
    c.Overlay.prototype = {
        _init: function (e) {
            ...
            this.placement =
                void 0 === e.placement ? c.Placement.TOP_LEFT : e.placement;
        ...
        _getOverlayPositionAndSize: function (e) {
            ...
            if (
                e.degrees &&
                this.rotationMode !== c.OverlayRotationMode.NO_ROTATION
            )
                if (
                    this.rotationMode === c.OverlayRotationMode.BOUNDING_BOX &&
                    null !== this.width &&
                    null !== this.height
                ) {
        ...
        _getSizeInPixels: function (e) {
            ...
            if (null !== this.width || null !== this.height) {
                var n = e.deltaPixelsFromPointsNoRotate(
                    new c.Point(this.width || 0, this.height || 0),
                    !0
                );
        ...
        update: function (e, t) {
            ...
            this._init({
                ...
                placement:
                    void 0 !== i.placement ? i.placement : this.placement,
        ...
        _adjustBoundsForRotation: function (e, t) {
            if (
                !e ||
                0 === e.degrees ||
                this.rotationMode === c.OverlayRotationMode.EXACT
            )
                return t;
            if (this.rotationMode !== c.OverlayRotationMode.BOUNDING_BOX)
            ...
            return e.viewerElementToViewportRectangle(
                new c.Rect(i.position.x, i.position.y, i.size.x, i.size.y)
            );
        },
    };
})(OpenSeadragon);
!(function (u) {
    u.Drawer = function (e) {
        ...
        var t = arguments;
        u.isPlainObject(e) ||
            (e = { source: t[0], viewport: t[1], element: t[2] });
        ...
        this.debugGridColor =
            'string' == typeof e.debugGridColor
                ? [e.debugGridColor]
                : e.debugGridColor || u.DEFAULT_SETTINGS.debugGridColor;
        e.opacity &&
            u.console.error(
                '[Drawer] options.opacity is no longer accepted; set the opacity on the TiledImage instead'
            );
        this.useCanvas =
            u.supportsCanvas && (!this.viewer || this.viewer.useCanvas);
    ...
    u.Drawer.prototype = {
        ...
        viewportCoordToDrawerCoord: function (e) {
            ...
            return new u.Point(
                t.x * u.pixelDensityRatio,
                t.y * u.pixelDensityRatio
            );
        },
        ...
        viewportToDrawerRectangle: function (e) {
            ...
            var i = this.viewport.deltaPixelsFromPointsNoRotate(
                e.getSize(),
                !0
            );
            return new u.Rect(
                t.x * u.pixelDensityRatio,
                t.y * u.pixelDensityRatio,
                i.x * u.pixelDensityRatio,
                i.y * u.pixelDensityRatio
            );
        },
        ...
        blendSketch: function (e, t, i, n) {
            ...
            if (this.useCanvas && this.sketchCanvas) {
                ...
                if (r) {
                    ...
                    t = o.scale || 1;
                    var s =
                        (i = o.translate) instanceof u.Point
                            ? i
                            : new u.Point(0, 0);
                    var a = 0;
                    var l = 0;
                    ...
                    this.context.drawImage(
                        ...
                        s.x - a * t,
                        s.y - l * t,
                        (this.canvas.width + 2 * a) * t,
                        (this.canvas.height + 2 * l) * t,
                        -a,
                        -l,
                        this.canvas.width + 2 * a,
        ...
        drawDebugInfo: function (e, t, i, n) {
            if (this.useCanvas) {
                var o =
                    this.viewer.world.getIndexOfItem(n) %
                    this.debugGridColor.length;
                var r = this.context;
                r.save();
                r.lineWidth = 2 * u.pixelDensityRatio;
                r.font =
                    'small-caps bold ' + 13 * u.pixelDensityRatio + 'px arial';
                ...
                0 === n.viewport.degrees &&
                    n.getRotation(!0) % 360 == 0 &&
                    n._drawer.viewer.viewport.getFlip() &&
                    n._drawer._flip();
                r.strokeRect(
                    e.position.x * u.pixelDensityRatio,
                    e.position.y * u.pixelDensityRatio,
                    e.size.x * u.pixelDensityRatio,
                    e.size.y * u.pixelDensityRatio
                );
                ...
                if (0 === e.x && 0 === e.y) {
                    r.fillText(
                        ...
                        e.position.x * u.pixelDensityRatio,
                        (e.position.y - 30) * u.pixelDensityRatio
                    );
                    r.fillText(
                        'Pan: ' + this.viewport.getBounds().toString(),
                        e.position.x * u.pixelDensityRatio,
                        (e.position.y - 20) * u.pixelDensityRatio
                    );
                }
                r.fillText(
                    'Level: ' + e.level,
                    (e.position.x + 10) * u.pixelDensityRatio,
                    (e.position.y + 20) * u.pixelDensityRatio
                );
                r.fillText(
                    'Column: ' + e.x,
                ...
                r.fillText(
                    'Row: ' + e.y,
                    (e.position.x + 10) * u.pixelDensityRatio,
                    (e.position.y + 40) * u.pixelDensityRatio
                );
                r.fillText(
                    'Order: ' + i + ' of ' + t,
                    (e.position.x + 10) * u.pixelDensityRatio,
                    (e.position.y + 50) * u.pixelDensityRatio
                );
                r.fillText(
                    'Size: ' + e.size.toString(),
                    (e.position.x + 10) * u.pixelDensityRatio,
                    (e.position.y + 60) * u.pixelDensityRatio
                );
                r.fillText(
                    'Position: ' + e.position.toString(),
                    (e.position.x + 10) * u.pixelDensityRatio,
                    (e.position.y + 70) * u.pixelDensityRatio
                );
        ...
        debugRect: function (e) {
            if (this.useCanvas) {
                ...
                t.strokeRect(
                    e.x * u.pixelDensityRatio,
                    e.y * u.pixelDensityRatio,
                    e.width * u.pixelDensityRatio,
                    e.height * u.pixelDensityRatio
                );
                t.restore();
            }
        },
        ...
        _offsetForRotation: function (e) {
            var t = e.point
                ? e.point.times(u.pixelDensityRatio)
...
!(function (p) {
    p.Viewport = function (e) {
        var t = arguments;
        t.length &&
            t[0] instanceof p.Point &&
            (e = { containerSize: t[0], contentSize: t[1], config: t[2] });
        if (e.config) {
    ...
    p.Viewport.prototype = {
        ...
        _applyBoundaryConstraints: function (e) {
            ...
            if (!this.wrapHorizontal) {
                ...
                var s = o - t.x - i;
                i > this._contentBoundsNoRotate.width
                    ? (t.x += (r + s) / 2)
                    : s < 0
                    ? (t.x += s)
                    : 0 < r && (t.x += r);
            ...
            if (!this.wrapVertical) {
                ...
                var u = h - t.y - a;
                a > this._contentBoundsNoRotate.height
                    ? (t.y += (c + u) / 2)
                    : u < 0
                    ? (t.y += u)
                    : 0 < c && (t.y += c);
        ...
        zoomTo: function (e, t, i) {
            var n = this;
            this.zoomPoint =
                t instanceof p.Point && !isNaN(t.x) && !isNaN(t.y) ? t : null;
            i
        ...
        _updateContainerInnerSize: function () {
            this._containerInnerSize = new p.Point(
                Math.max(
                    1,
        ...
        imageToWindowCoordinates: function (e) {
            ...
            return this.imageToViewerElementCoordinates(e).plus(
                p.getElementPosition(this.viewer.element)
            );
        },
...
!(function (y) {
        ...
        y.extend(
            ...
            this,
            {
                ...
                smoothTileEdgesMinZoom:
                    y.DEFAULT_SETTINGS.smoothTileEdgesMinZoom,
    ...
    y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
        ...
        _viewportToImageDelta: function (e, t, i) {
            ...
            return new y.Point(
                e * (this.source.dimensions.x / n),
                t * ((this.source.dimensions.y * this.contentAspectX) / n)
            );
        },
        ...
        fitBounds: function (e, t, i) {
            ...
            if (e.getAspectRatio() > o) {
                ...
                n.isHorizontallyCentered
                    ? (c = (e.width - e.height * o) / 2)
                    : n.isRight && (c = e.width - e.height * o);
                ...
                n.isVerticallyCentered
                    ? (d = (e.height - e.width / o) / 2)
                    : n.isBottom && (d = e.height - e.width / o);
        ...
        _updateViewport: function () {
            ...
            !(function (n, e) {
                if (
                    0 === n.opacity ||
                    (0 === e.length && !n.placeholderFillStyle)
                )
                    return;
                var t = e[0];
                var i;
                t &&
                    (i =
                        ...
                        (n.compositeOperation &&
                            'source-over' !== n.compositeOperation) ||
                        (!n._isBottomItem() && t._hasTransparencyChannel()));
                var o;
                var r;
                ...
                if (
                    ...
                    r = t.getTranslationForEdgeSmoothing(
                        o,
                        n._drawer.getCanvasSize(!1),
                        n._drawer.getCanvasSize(!0)
                    );
                }
                var l;
                if (i) {
                    if (!o) {
                        ...
                        n._drawer.viewer.viewport.getFlip() &&
                            ((0 === n.viewport.degrees &&
                                n.getRotation(!0) % 360 == 0) ||
                                (l.x =
                                    n._drawer.viewer.container.clientWidth -
                                    (l.x + l.width)));
                ...
                if (n.placeholderFillStyle && !1 === n._hasOpaqueTile) {
                    var p = n._drawer.viewportToDrawerRectangle(
                        n.getBounds(!0)
                    );
                    o && (p = p.times(o));
                    r && (p = p.translate(r));
                    var g = null;
                    g =
                        'function' == typeof n.placeholderFillStyle
                            ? n.placeholderFillStyle(n, n._drawer.context)
                ...
                for (var m = e.length - 1; 0 <= m; m--) {
                    ...
                    t.beingDrawn = !0;
                    n.viewer &&
                        n.viewer.raiseEvent('tile-drawn', {
                            tiledImage: n,
                            tile: t,
                        });
                }
                ...
                if (!o) {
                    n.getRotation(!0) % 360 != 0 &&
                        n._drawer._restoreRotationChanges(i);
                    0 !== n.viewport.degrees &&
                        n._drawer._restoreRotationChanges(i);
                }
                if (i) {
                    ...
                    if (o) {
                        n.getRotation(!0) % 360 != 0 &&
                            n._drawer._restoreRotationChanges(!1);
                        0 !== n.viewport.degrees &&
                            n._drawer._restoreRotationChanges(!1);
                    }
                }
    ...
    function T(e, t, i, n, o, r, s, a, l, h, c, u) {
        var d = (function (e, t, i, n, o, r, s, a, l, h) {
                ...
                if (!r[i][e][t]) {
                    ...
                    if (n.loadTilesWithAjax) {
                        ...
                        y.isPlainObject(n.ajaxHeaders) &&
                            (v = y.extend({}, n.ajaxHeaders, v));
                    } else v = null;
                ...
                c,
                h,
                e._worldWidthCurrent,
                e._worldHeightCurrent
            ),
            p = i;
        e.viewer &&
            e.viewer.raiseEvent('update-tile', { tiledImage: e, tile: d });
        ...
        t &&
            !p &&
            (w(e.coverage, r, n, o) ? x(e.coverage, r, n, o, !0) : (p = !0));
        if (!p) return u;
...
!(function (g) {
    ...
    g.TileCache = function (e) {
        ...
        this._maxImageCacheCount =
            e.maxImageCacheCount || g.DEFAULT_SETTINGS.maxImageCacheCount;
        this._tilesLoaded = [];
        this._imagesLoaded = [];
        ...
        cacheTile: function (e) {
            ...
            if (this._imagesLoadedCount > this._maxImageCacheCount) {
                ...
                for (var p = this._tilesLoaded.length - 1; 0 <= p; p--)
                    if (
                        !(
                            (a = (d = this._tilesLoaded[p]).tile).level <= t ||
                            a.beingDrawn
                        )
                    )
                        if (o) {
...
!(function (v) {
    v.World = function (e) {
        ...
        this._delegatedFigureSizes = function (e) {
            t._autoRefigureSizes
                ? t._figureSizes()
                : (t._needsSizesFigured = !0);
        };
        this._figureSizes();
    };
    v.extend(v.World.prototype, v.EventSource.prototype, {
        ...
        arrange: function (e) {
            ...
            var s =
                r + (e.tileMargin || v.DEFAULT_SETTINGS.collectionTileMargin);
            var a;
